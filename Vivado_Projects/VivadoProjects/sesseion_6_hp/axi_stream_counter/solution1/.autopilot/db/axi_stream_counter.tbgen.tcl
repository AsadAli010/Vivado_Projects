...
set C_modelArgList {
	{ counter_output int 32 regular {axi_s 1 volatile  { counter_output Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "counter_output", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "counterValue", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_counter_output_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	axi_stream_counter {
		counter_output {Type O LastRead -1 FirstWrite 0}
		counterValue {Type IO LastRead -1 FirstWrite -1}}}
