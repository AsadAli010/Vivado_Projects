...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_stream_counter.autotvin.dat"
	set constFileTvOut       "axi_stream_counter.autotvout.dat"
	set constFileHdlTvIn     "axi_stream_counter.autohdltvin.dat"
	set constFileHdlTvOut    "axi_stream_counter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
