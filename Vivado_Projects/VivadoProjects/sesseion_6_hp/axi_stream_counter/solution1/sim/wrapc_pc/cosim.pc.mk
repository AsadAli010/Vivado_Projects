...
$(ObjDir)/axi_stream_counter_test_bench.cpp_pre.cpp.tb.o : axi_stream_counter_test_bench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axi_stream_counter_test_bench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/axi_stream_counter.cpp_pre.cpp.tb.o : axi_stream_counter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axi_stream_counter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
