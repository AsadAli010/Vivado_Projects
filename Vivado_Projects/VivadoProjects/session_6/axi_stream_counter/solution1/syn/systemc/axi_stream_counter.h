...
struct axi_stream_counter : public sc_module {
    ...
    sc_signal< sc_lv<32> > counterValue_assign_fu_33_p2;
    sc_signal< sc_logic > ap_sig_ioackin_counter_output_TREADY;
    sc_signal< sc_logic > ap_reg_ioackin_counter_output_TREADY;
    ...
    void thread_ap_sig_ioackin_counter_output_TREADY();
    void thread_counterValue_assign_fu_33_p2();
