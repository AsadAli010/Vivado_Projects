...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/Thesis_vivado_project/Vivado_Projects/VivadoProjects/session_7_hp/axis_example/vivado/project_2/project_2.cache/compile_simlib/modelsim"
  fi
